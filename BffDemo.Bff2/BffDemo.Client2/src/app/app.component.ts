...
export class AppComponent {
  ...
  getData() {
    return this.http.get('https://bff2.localhost:5002/api2/email', {
      withCredentials: true,
      headers: new HttpHeaders({
        "X-CSRF": "1",
      })
  ...
  onLogout(e: any) {
    window.location.href = `https://bff2.localhost:5002${this.getClaim("bff:logout_url")}&returnUrl=http://localhost:4201`
  }
}
